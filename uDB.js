...
class uDB {
    static getDataFolder() {
        if (typeof DriveApp === "undefined")
            throw new Error("Only supported on Google Apps Script.");
        ...
        if (typeof window !== "undefined" || typeof process !== "undefined") {
            ...
            if (fileIterator.hasNext()) {
                ...
                if (file.endsWith(fileExtension))
                    keys.push(
                        file.slice(0, file.length - fileExtension.length)
                    );
            }
        } else {
    ...
    constructor(store) {
        ...
        if (typeof window !== "undefined" || typeof process !== "undefined") {
            ...
            getAll = () =>
                doWithLock(() => {
                    const fileIterator = uDB
                        .getDataFolder()
                        .getFilesByName(file);
                    if (!fileIterator.hasNext()) return [];
                    const json = fileIterator
                        .next()
                        .getAs(mimeType)
                        .getDataAsString();
        ...
        this.put = (doc) =>
            doWithLock(() => {
                if (typeof doc !== "object")
                    throw Error('Document must be of type "object"');
